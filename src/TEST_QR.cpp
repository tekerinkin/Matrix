...
int main()
{
...

    {
        ...
        Matrix2<double> Q (3,3);
        Matrix2<double> R (3,3);
...

    {
        ...
        Matrix2<double> testMatrix(4, 4, simpleData);
        testMatrix.PrintMatrix();
        cout << endl;
        cout << "Computing QR decomposition..." << endl;
        Matrix2<double> Q (4,4);
        Matrix2<double> R (4,4);
        int status = QR(testMatrix, Q, R);
        cout << "R = " << endl;
        R.PrintMatrix();
        cout << endl;
...

    {
        ...
        Matrix2<double> testMatrix(5, 5, simpleData);
        testMatrix.PrintMatrix();
        cout << endl;
        cout << "Computing QR decomposition..." << endl;
        Matrix2<double> Q (5,5);
        Matrix2<double> R (5,5);
        int status = QR(testMatrix, Q, R);
        cout << "R = " << endl;
        R.PrintMatrix();
        cout << endl;
...

    {
        ...
        Matrix2<double> testMatrix(10, 10, simpleData);
        testMatrix.PrintMatrix();
        cout << endl;
        cout << "Computing QR decomposition..." << endl;
        Matrix2<double> Q (10,10);
        Matrix2<double> R (10,10);
        int status = QR(testMatrix, Q, R);
        cout << "R = " << endl;
        R.PrintMatrix();
        cout << endl;
...

    {
        ...
        Matrix2<float> testMatrix(10, 10, simpleData);
        testMatrix.PrintMatrix();
        cout << endl;
        cout << "Computing QR decomposition..." << endl;
        Matrix2<float> Q (10,10);
        Matrix2<float> R (10,10);
        int status = QR(testMatrix, Q, R);
        cout << "R = " << endl;
        R.PrintMatrix();
        cout << endl;
        ...
        cout << endl;
        cout << "QR = " << endl;
        Matrix2<float> QR = Q*R;
        QR.PrintMatrix();
        cout << endl;
    }

    {
        cout << "Testing random <float> matrix: " << endl;
        int n;
        cout << "Input size: " << endl;
        cin >> n;
        std::vector<float> simpleData(n*n);
        cout << "Size of matrix: " << n << "x" << n << endl;
        for(float& i : simpleData)
            i = rand()%100 + 10;
        Matrix2<float> testMatrix(n, n, simpleData);
        testMatrix.PrintMatrix();
        cout << endl;
        cout << "Computing QR decomposition..." << endl;
        Matrix2<float> Q (n,n);
